...
export default function MabarOwn() {
    // utils
    ...
    const fetchAllDataMabar = async () => {
        try {
            const response = await axios.post(`${BE_MAIN_URL}/mabar/mabar-own`,
                {user_id : user._id}
            )
  ...
  return (
    ...
    {/* <Header /> */}
          ...
          <TouchableOpacity onPress={() => navigation.goBack()} style={styles.header}>
            ...
            <Text style={styles.headerTitle}>Event Mabar yang Anda Buat</Text>
          </TouchableOpacity>
